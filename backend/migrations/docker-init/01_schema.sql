-- Mounted at /docker-entrypoint-initdb.d when MYSQL_DATABASE=asientos (image creates DB first)
-- Secondary indexes: GORM AutoMigrate (see internal/database/database.go)
USE asientos;
